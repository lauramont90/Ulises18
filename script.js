...
const targetDate = new Date('2024-04-21 13:00:00').getTime();
...
botonWhatsapp.addEventListener("click", function() {
    ...
    const urlWhatsapp = "https://wa.me/+541158478511?text=Mi%20nombre%20y%20apellido%20es...%20Gracias%20por%20la%20invitación";
...
botonGoogleMaps.addEventListener("click", function() {
    const urlGoogleMaps = "https://maps.app.goo.gl/dms8Fs4zkavzrtHS8";
